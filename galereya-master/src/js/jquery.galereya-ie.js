...
//grace--
        ...
        var buildDOM = function () {
            ...
            var $img, title, desc, hideDesc = '', hlink, aps,ap='';
...
//grace++
                    .wrap('<a href="#" onclick=switchTab("mywork",'+i+')>'+'<div class="galereya-cell" data-index="' + i + '"></div>'+'</a>')
                    .parent()
                    .append(  ap+
...
//            $(document.body).append($slider);
        ...
        var loadImages = function (index, category) {
            alert('loadImages:'+ index + ',category:'+category);
            index = index || 0;

            if (index >= $imgs.length) {
                alert('index:'+ index + ',$imgs.length:'+$imgs.length);
                return;
            }
