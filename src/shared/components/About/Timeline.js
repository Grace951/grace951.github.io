            ...
            <div className="cd-timeline-content ">
                <div className="media">
                    ...
                    <div className="media-img online">
                        <a href="https://www.pluralsight.com/" target="_blank"><img className="img-responsive" src="images/Timelines/pluralsight.png" alt=""/></a>
                        <a href="https://www.udemy.com/" target="_blank" ><img className="img-responsive" src="images/Timelines/codeSchool.svg" style={{maxWidth: "140px"}} alt=""/></a>
                        <a href="https://egghead.io/" target="_blank" ><img className="img-responsive" src="images/Timelines/egghead.svg" style={{width: "50px"}} alt=""/></a>
                    </div>
                </div>
                <ul className="background">
